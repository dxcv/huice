...
class CtaTemplate(object):
    ...
    def sendOrder(self, orderType, price, volume, stop=False):
        ...
        if self.trading:
            ...
            if stop:
                vtOrderIDList = self.ctaEngine.sendStopOrder(self.ctaEngine.tick.symbol, orderType, price, volume, self)
            else:
                vtOrderIDList = self.ctaEngine.sendOrder(self.ctaEngine.tick.symbol, orderType, price, volume, self)
